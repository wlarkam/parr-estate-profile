...
export const ARCHETYPES = {
  ...
  optimist: {
    ...
    blurb:
      "Something is in place — maybe a will from 2015, maybe life insurance, maybe both — but the rest is assumption. Probate exposure is significant and your family would be improvising under stress.",
