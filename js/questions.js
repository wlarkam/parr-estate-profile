...
export const QUESTIONS = [
  {
    ...
    type: 'calibration',
    prompt:
      "Roughly, what's your current net estate value? (real estate equity + investments + business value + insurance − debts)",
    options: [
  ...
  },
  {
    ...
    type: 'scored',
    dimension: 'will',
    prompt: 'Your will — most accurate statement:',
    options: [
      ...
      { value: 'C', label: "A few years old — some things have changed I haven't reflected" },
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'B', label: "I have a POA in place — they'd figure it out from my docs" },
  ...
  },
  {
    ...
    options: [
      { value: 'A', label: 'Within an hour — organized in a known location with a written index' },
